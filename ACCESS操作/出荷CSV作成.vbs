...
Sub Main()
	...
	RunOn32bit
	call getCSV("C:\work\in\DB\1705_Wish TRU0020リペア入出荷ツールPD_Ver230.mdb","OK出荷品","製品番号","C:\work\in\DB\WIPD\出荷CSV.CSV")
	call getCSV("C:\work\in\DB\1705_Wish TRU0020リペア入出荷ツールSK_Ver230.mdb","OK出荷品","製品番号","C:\work\in\DB\WISK\出荷CSV.CSV")
...
Sub getCSV(DB_Path,DB_Table,DB_Field,OutPath)

	logPrintln(DB_Path & "," & DB_Table & "," & DB_Field & "," & OutPath)
	...
	logPrintln(DB_Path)
	Ret = m_dbt.getFieldValue(DB_Table,DB_Field)
	logPrintln("Ret:" & ret)
