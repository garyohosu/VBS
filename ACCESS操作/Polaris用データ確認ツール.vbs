...
Sub Main()
	...
	DB_Path="Y:\RS-335\DB\RS-335_2000.mdb"
	DB_Table="Data"
	DB_Key_Field = "工程管理番号"
	...
	do
		DB_KEY = inputbox("製番 終わるときはEnter")
		if DB_KEY<>"" then
			DB_KEY=left(DB_KEY,len(DB_KEY)-1)
			Ret = m_dbt.get1Recode(DB_Table,DB_Key_Field,DB_Key)
